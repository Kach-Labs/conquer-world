    ...
    <div className="flex min-h-screen items-center justify-center bg-charcoal px-4 text-white">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md bg-fire px-5 py-2.5 text-sm font-semibold text-white shadow-fire transition hover:brightness-110"
          >
            Return home
          </Link>
        </div>
    ...
    <div className="flex min-h-screen items-center justify-center bg-charcoal px-4 text-white">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center rounded-md border border-white/20 bg-white/5 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-white/10"
          >
            Go home
          </a>
        </div>
